...
public final class ItemDeviceBinding implements ViewBinding {
  ...
  private ItemDeviceBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvDeviceAddress,
      @NonNull TextView tvDeviceName, @NonNull TextView tvRssi) {
  ...
  public static ItemDeviceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemDeviceBinding((MaterialCardView) rootView, tvDeviceAddress, tvDeviceName,
          tvRssi);
    }
